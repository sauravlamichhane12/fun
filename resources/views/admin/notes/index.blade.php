...
<div class="row">
    ...
    <button type="button" class="btn btn-default" style="" disabled>
               ...
               <a href="{{ route('notes.create') }}"><button type="button" class="btn btn-primary" style="float:right">
                 Add Notes</button></a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @php 
    $note=Db::table('online_classes')->where('id',$notebook->note_id)->select('name')->first();
                  ...
                  <td>@if($note !=null){{ $note->name }} @endif</td>
                  <td>{{ $notebook->name }}</td>
                  <td>

                

<a href="{{ route('notes.show',$notebook->id) }}" target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>

</td>
                    <td><a href="{{ route('notes.edit',$notebook->id) }}"><button type="button" class="btn btn-info btn-sm">

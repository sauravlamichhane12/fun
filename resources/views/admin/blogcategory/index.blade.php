...
<div class="row">
    ...
    <button type="button" class="btn btn-default" style="" disabled>
                <h5>List of blogcategory information</h5></button>

               <a href="{{ route('blogcategory.create') }}"><button type="button" class="btn btn-primary" style="float:right">
               Add blog category</button></a>

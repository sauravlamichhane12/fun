...
@endif
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Maintenace</h3>
              </div>

      
              <!-- /.card-header -->
              <!-- form start -->
              <form   method="post" action="{{ route('maintenace.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="ip_address" class="form-control"  placeholder="Enter the ip address" value="{{ old('ip_address')}}">
                  </div>

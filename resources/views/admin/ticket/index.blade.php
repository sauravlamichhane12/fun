...
<div class="col-sm-12">
    ...
    <button type="button" class="btn btn-default" style="" disabled>
                <h5>List of Ticket</h5></button>

               <a href="{{ route('ticket.create') }}"><button type="button" class="btn btn-primary" style="float:right">
               Add Ticket</button></a>
     ...
     $username=Db::table('users')->where('id',$ticket->user_id)->select('name')->first();
                ...
                <tr>
                  ...
                  <td>#{{ $ticket->ticket_code  }}</td>
                    ...
                    <td><a href="{{ route('ticket.edit',$ticket->id) }}"><button type="button" class="btn btn-info btn-sm">
                    <i class="fas fa-pen"></i></button></a>
                    <button type="button" class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#modal-default" onclick="handleDelete({{ $ticket->id  }})">

...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <button type="button" class="btn btn-default" style="" disabled>
                <h5>List of Booking Events</h5></button>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td>{{ $i++ }}</td>
                    ...
                    <td>{{ $event->message }}</td>
                    <td>{{ $event->date }}</td>
                     <td><input type="time" value="{{ $event->time }}" disabled></td>
                    <td>  
                    <button type="button" class="btn btn-danger btn-sm"  data-toggle="modal" data-target="#modal-default" onclick="handleDelete({{ $event->id  }})">
 ...
 function handleDelete(id){
   ...
   form.action='/admin/event/delete/' + id
